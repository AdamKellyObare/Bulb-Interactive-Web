...
export class StoryComponent implements OnInit {
  upcomingEvents: any[] = [
    {
      "id": 1,
      "title": "Business b4 Vals",
      "image": "/assets/images/events/interior_design.jpeg",
      "description": "This workshop is ideal for those considering starting an LLC, as well as established and start-up LLC businesses seeking compliance and effective management strategies.",
      "date":"25-01-2024"
    },
    {
      "id": 1,
  ...
  pastEvents: any[] = [
    {
      "id": 1,
      "title": "Business b4 Vals",
      "image": "/assets/images/bulb-event.jpeg",
      "description": "This workshop is ideal for those considering starting an LLC, as well as established and start-up LLC businesses seeking compliance and effective management strategies."
    },
  ];
  currentSlideIndex = 0;
